            ...
            <div class="col-cont">
            	 			<ul>
                               <li><a href="beranda.php?page=allberita">Berita</a></li>
								<li><a href="beranda.php?page=alkegiatan">Kegiatan</a></li>
...
$tampil="select * from kegiatan order by idkeg desc limit $posisi,$batas ";
$hasil=mysqli_query($conn,$tampil);
while ($r=mysqli_fetch_assoc($hasil)){
?>                      
        <div class="newsHeadline">
            <h3><b><a class="headline-text" target="_blank" title="" href="beranda.php?page=kegiatan&&idkeg=<?php echo $r[idkeg] ?>"><?php echo $r['judul'] ?></a></b>
            </h3>
            <div class="thumbs">
    ...
    <em style="font-size:11px">&nbsp;&nbsp;&nbsp;<?php echo "......<br/><a href=beranda.php?page=kegiatan&&idkeg=".$r['idkeg'].">" ?>&nbsp;&nbsp;(selengkapnya)</em></a>
            </div>
            <div class="clear"></div>
        </div><br><?php }
...
if($halaman > 1){
	$prev=$halaman-1;
	echo "<span class=prevnext><a href=$_SERVER[PHP_SELF]?page=allkegiatan&&halaman=$prev>« Prev</a></span> ";
}
else{ 
...
if($halaman < $jmlhal){
	$next=$halaman+1;
	echo "<span class=prevnext><a href=$_SERVER[PHP_SELF]?page=allkegiatan&&halaman=$next>Next »</a></span>";
}
else{ 
