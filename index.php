...
<title>Universitas Madura</title>
    ...
    <link rel="stylesheet" id="wpe-style-css" href="./css/custom.css" type="text/css" media="all">
...
<div id="main">
       ...
       <?php include "includes/pengumuman.php";?> 
	   <?php include "includes/headline.php";?>
       <?php include "includes/kegiatan.php";?>
       <?php include "includes/berita.php";?>
       <?php //include "includes/lain.php";?>  
