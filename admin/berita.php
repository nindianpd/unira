...
<script language="JavaScript">
   function konfirmasi(berita)
   {
       tanya = confirm('Anda yakin ingin menghapus berita '+ berita + '?');
...
<?php
	echo"
<td align='right'><a href=\"deleteberita.php?idberita=$r[idberita]\" onclick=\"return konfirmasi('$r[judul]')\" title=\"Delete\">"
?>[Delete]</a> 
					  <a href="administrator.php?page=editberita&&id=<?php echo $r['idberita']; ?>" title='Edit'>[Edit] </a>    </td>
						</tr>
<?php } ?>
                    </tbody>
                    <tfoot>
