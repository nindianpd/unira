...
<script language="JavaScript">
   function konfirmasi(admin)
   {
       tanya = confirm('Anda yakin ingin menghapus admin '+ admin + '?');
...
<?php
	echo"
<td align='right'><a href=\"deleteadmin.php?idadmin=$r[idadmin]\" onclick=\"return konfirmasi('$r[nama]')\" title=\"Delete\">"
?>[Delete]</a> 
					  <a href="administrator.php?page=edituser&&id=<?php echo $r['idadmin']; ?>" title='Edit'>[Edit] </a>    </td>
						</tr>
<?php } ?>
                    </tbody>
                    <tfoot>
