...
<script language="JavaScript">
   function konfirmasi(pengumuman)
   {
       tanya = confirm('Anda yakin ingin menghapus pengumuman '+ pengumuman + '?');
...
<?php
	echo"
<td align='right'><a href=\"deletepengumuman.php?idpeng=$r[idpeng]\" onclick=\"return konfirmasi('$r[judul]')\" title=\"Delete\">"
?>[Delete]</a> 
					  <a href="administrator.php?page=editpeng&&id=<?php echo $r['idpeng']; ?>" title='Edit'>[Edit] </a>    </td>
						</tr>
<?php } ?>
                    </tbody>
                    <tfoot>
