<?php   
    ...
    {
    $id=$_GET['id'];
    $query = "select * from kegiatan where idkeg='$id'";
            ...
            <div class="col-xs-12">
			 <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Edit Kegiatan</h3><br><br>          
                    <div class="form-group">					
                <form action="proseseditkeg.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">   
                
                <div class="form-group">   
				<input type="hidden" class="form-control" id="idkeg" name="idkeg" style="width:90%" placeholder="idkeg" value="<?php echo $edit['idkeg']; ?>" />
                </div>
