<?php if(isset($_COOKIE["username"])){ ?><html><head>
            ...
            <div class="col-xs-12">
			 <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tambah kegiatan</h3><br><br>          
                    <div class="form-group">					
                <form action="simpankeg.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">  
                <div class="form-group">    
				...
				<textarea name="isi" id="alamat" cols="90" rows="16"></textarea>
                </div>
