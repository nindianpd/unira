            ...
            <div class="col-xs-12">
			 <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tambah Pengumuman</h3><br><br>          
                    <div class="form-group">					
                <form action="simpanpeng.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">   
                <div class="form-group">    
				<label for="judul">Judul</label>
				<input type="search" class="form-control" id="judul" name="judul" style="width:90%" placeholder="Judul" value="" />
                </div>
				
                <div class="form-group">
				<label for="isi">Isi</label>
				<textarea name="isi" id="isi" cols="90" rows="16"></textarea>
                </div>
                    
				<div class="form-group">
                <label for="isi">Tanggal</label>
						<input type="date" name="wkt" id="" class="form-control" value="<?php echo DATE('d/m/Y');?>" style="width:30%">
				</div>
                    
                <div class="form-group">    
				<label for="isi">Headline</label>
				<select name="headline" class="form-control" style="width:30%">
				...
				<input type="file" name="fupload" id="fupload" class="form-group" />
				<div class="form-group"></div>
