            ...
            <div class="col-xs-12">
			 <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tambah Berita</h3><br><br>          
                    <div class="form-group">					
                <form action="simpanberita.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div style="display:none">
                <input type="hidden" name="csrf_test_name" value="cf5101542245ac84ff7c9320e3e25e5c" />
                </div>  
                <div class="form-group">    
