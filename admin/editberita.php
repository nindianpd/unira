            ...
            <div class="col-xs-12">
			 <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Edit Berita</h3><br><br>          
                    <div class="form-group">					
                <form action="proseseditberita.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">   
                
                <div class="form-group">   
				<input type="hidden" class="form-control" id="idberita" name="idberita" style="width:90%" placeholder="idberita" value="<?php echo $edit['idberita']; ?>" />
                </div>
